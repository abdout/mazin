...
const projectsData = [
  {
    customer: "Al-Faisal Trading Co.",
    blAwbNumber: "MSKU2024001",
    description: "Automotive spare parts from Japan",
  ...
  {
    customer: "Sudan Pharmaceuticals",
  ...
  {
    customer: "Al-Rashid Construction",
    ...
    team: ["2"],
    teamLead: "2",
    portOfOrigin: "Dubai, UAE",
    portOfDestination: "Port Sudan",
  },
  {
    customer: "Nile Agricultural Supplies",
  ...
  },
  {
    ...
    team: ["3"],
    teamLead: "3",
    portOfOrigin: "Frankfurt, Germany",
    portOfDestination: "Khartoum International",
  },
  {
    customer: "Fashion House Khartoum",
    blAwbNumber: "AWB2024002",
    description: "Textile and fashion merchandise",
    systems: ["IMPORT_AIR"],
    activities: importAirActivities,
    status: "IN_PROGRESS" as const,
    ...
    team: ["1"],
    teamLead: "1",
    portOfOrigin: "Istanbul, Turkey",
    portOfDestination: "Khartoum International",
  },
  {
    customer: "Sudan Cotton Exports",
    blAwbNumber: "EXP2024001",
    description: "Cotton bales for export",
    systems: ["EXPORT_SEA"],
  ...
  {
    customer: "Gum Arabic Corp",
    blAwbNumber: "EXP2024002",
    description: "Gum arabic shipment to Europe",
    systems: ["EXPORT_SEA"],
    activities: exportSeaActivities,
    status: "IN_PROGRESS" as const,
    priority: "MEDIUM" as const,
    ...
    teamLead: "1",
    portOfOrigin: "Port Sudan",
    portOfDestination: "Hamburg, Germany",
  },
  {
    customer: "Regional Transit Co.",
    blAwbNumber: "TRN2024001",
    description: "Transit cargo to Chad",
    systems: ["TRANSIT"],
    ...
    teamLead: "3",
    portOfOrigin: "Port Sudan",
    portOfDestination: "N'Djamena, Chad",
  },
  {
    customer: "African Logistics Group",
    blAwbNumber: "TRN2024002",
    description: "Transit machinery to South Sudan",
    systems: ["TRANSIT"],
    activities: transitActivities,
    status: "PENDING" as const,
    priority: "LOW" as const,
    ...
    teamLead: "2",
    portOfOrigin: "Port Sudan",
    portOfDestination: "Juba, South Sudan",
  },
  {
    customer: "Red Sea Mining Corp",
    ...
    team: ["1", "2", "3"],
    teamLead: "1",
    portOfOrigin: "Durban, South Africa",
    portOfDestination: "Port Sudan",
  },
]
