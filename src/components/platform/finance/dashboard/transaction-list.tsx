  ...
  if (transactions.length === 0) {
    return (
      <Card className={className}>
        <CardHeader>
          <CardTitle>{f?.recentTransactions ?? ""}</CardTitle>
          <CardDescription>
            {f?.noTransactions ?? ""}
          </CardDescription>
        </CardHeader>
    ...
    <Card className={className}>
      ...
      <CardContent>
        ...
        <div className="mt-4 grid grid-cols-3 gap-4 border-t pt-4 text-center">
          <div>
            <p className="text-muted-foreground text-xs">{f?.totalIncome ?? ""}</p>
          ...
          <div>
            <p className="text-muted-foreground text-xs">{f?.totalExpenses ?? ""}</p>
          ...
          <div>
            <p className="text-muted-foreground text-xs">{f?.statuses?.PENDING ?? ""}</p>
