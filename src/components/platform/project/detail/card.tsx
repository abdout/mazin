    ...
    <div style={{ transform: 'scale(0.8)' }}>
      <div className='flex flex-col'>
          ...
          <div className="flex gap-[14px] mb-2">
              <div className="border rounded-full inline-block overflow-hidden">
                  <Image src={props.photo} alt={props.name} width={48} height={48} className="rounded-full" />
              </div>
              <div>
                  <h3>{props.name}</h3>
                  <h4>{props.rank}</h4>
          ...
          <div className="space-y-2">
              <div className="flex gap-4 ms-[12px]">
