    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col pt-4 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
...
// Deterministic widths for menu skeletons — avoids Math.random() during render
// which would cause hydration mismatches and purity violations.
const SKELETON_WIDTHS = ["55%", "65%", "72%", "80%", "88%"] as const
